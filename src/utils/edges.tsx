...
const initialEdges = [
  ...
  {
    id: 'decisionNodeEdge1',
    source: 'processNode_4',
    target: 'decisionNode_1',
    targetHandle: 'decisionTarget1',
  },
  {
    id: 'decisionNodeEdge2',
    source: 'decisionNode_1',
    target: 'processNode_5',
    sourceHandle: 'decisionSource2',
    label: 'No',
  },
  ...
  {
    id: 'decisionNodeEdge3',
    source: 'processNode_7',
    target: 'decisionNode_1',
    targetHandle: 'decisionTarget2',
  },
  {
    id: 'decisionNodeEdge4',
    source: 'decisionNode_1',
    target: 'endNode_1',
    sourceHandle: 'decisionSource1',
